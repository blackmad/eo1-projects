...
function updateSearch(options) {
  ...
  console.log(options)
  if (params['instagram']) {
    return jQuery.get('/instagram/posts', options, process_search_response);
  } 
  
  if (params['twitter']) {
    return jQuery.get('/twitter/posts', options, process_search_response);
  } 
  
  return jQuery.get('/tumblr/posts', options, process_search_response);
}
